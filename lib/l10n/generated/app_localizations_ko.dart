...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get translationInfoDesc =>
      '숙어를 볼 때 자동으로 번역이 다운로드됩니다. 다운로드된 번역은 오프라인에서도 사용할 수 있도록 저장됩니다.';
  ...
  String get copyrightContent =>
      '이 앱의 모든 숙어 정의와 예문은 오리지널이거나 AI로 생성되었습니다. 저작권이 있는 사전 콘텐츠는 사용되지 않았습니다.';
  ...
  @override
  String get wordToMeaningMode => '숙어→뜻';

  @override
  String get meaningToWordMode => '뜻→숙어';
